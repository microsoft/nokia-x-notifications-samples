...
public final class CommonUtilities {
    private static final String TAG = "PushHelperDemo/CommonUtilities";
    
    // Intent used to display a message on the screen
    static final String DISPLAY_MESSAGE_ACTION = "com.nokia.push.helperdemo.DISPLAY_MESSAGE";
    
    // Intent used to trigger handling of push messages in the application
    static final String PROCESS_MESSAGES_ACTION = "com.nokia.push.helperdemo.PROCESS_MESSAGES";

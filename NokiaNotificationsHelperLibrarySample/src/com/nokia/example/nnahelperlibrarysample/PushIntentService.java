...
public class PushIntentService extends PushBaseIntentService {
    private static final String TAG = "PushHelperDemo/PushIntentService";
    ...
    protected void onUnregistered(Context context, String registrationId) {
        ...
        CommonUtilities.displayMessage(context, getString(R.string.push_unregistered));
    ...
    protected void onMessage(Context context, Intent intent) {
        ...
        String text = (messages > 1)
                ? getString(R.string.push_message_many, messages)
                : getString(R.string.push_message);
    ...
    protected void onDeletedMessages(Context context, int total) {
        ...
        String message = getString(R.string.push_deleted, total);
    ...
    public void onError(Context context, String errorId) {
        ...
        CommonUtilities.displayMessage(context, getString(R.string.push_error, errorId));
    }

    @Override
    protected boolean onRecoverableError(Context context, String errorId) {
        Log.i(TAG, "Received recoverable error: " + errorId);
        CommonUtilities.displayMessage(context, getString(R.string.push_recoverable_error, errorId));
